...
var Utils = class _Utils {
  ...
  static lazyLoad(n) {
    var _a, _b;
    return n.lazyLoad || ((_b = (_a = n.grid) == null ? void 0 : _a.opts) == null ? void 0 : _b.lazyLoad) && n.lazyLoad !== false;
  }
...
var GridStack = class _GridStack {
  ...
  constructor(el, opts = {}) {
    ...
    if (resp) {
      ...
      if (!resp.columnWidth && !(bk == null ? void 0 : bk.length)) {
    ...
    if (((_a = opts.draggable) == null ? void 0 : _a.pause) !== void 0)
      ...
      if (!n.visibleObservable) {
        n.visibleObservable = new IntersectionObserver(([entry]) => {
          ...
          if (entry.isIntersecting) {
            (_a = n.visibleObservable) == null ? void 0 : _a.disconnect();
            delete n.visibleObservable;
            _GridStack.renderCB(cont, n);
            (_b = n.grid) == null ? void 0 : _b.prepareDragDrop(n.el);
          }
        });
        window.setTimeout(() => {
          var _a;
          return (_a = n.visibleObservable) == null ? void 0 : _a.observe(el);
        });
      }
    } else
      _GridStack.renderCB(cont, n);
  ...
  destroy(removeDOM = true) {
    ...
    delete this.parentGridNode;
    delete this.opts;
    (_a = this._placeholder) == null ? true : delete _a.gridstackNode;
  ...
  updateOptions(o) {
    ...
    if ((_a = o.children) == null ? void 0 : _a.length)
  ...
  _setupAcceptWidget() {
    ...
    dd.droppable(this.el, {
      ...
      if (node == null ? void 0 : node._sidebarOrig) {
  ...
  prepareDragDrop(el, force = false) {
    const node = el == null ? void 0 : el.gridstackNode;
    if (!node)
      return;
